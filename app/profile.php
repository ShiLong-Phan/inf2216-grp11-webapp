...
if (isset($_GET['action'])) {
    if ($_GET['action'] === 'enable2fa') {
        // Copy the 2FA enable code here
        ...
        // Redirect back to profile page to avoid resubmission
        header("Location: profile.php?2fa_sent=true");
        exit();
    }

    if ($_GET['action'] === 'disable2fa') {
        // Copy the 2FA disable code here
        $user_id = $_SESSION['user_id'];
        ...
        header("Location: profile.php?2fa_disabled=true");
        exit();
    }
}

// And handle the redirect parameters
if (isset($_GET['2fa_sent'])) {
    $success_message = "A verification email has been sent to enable two-factor authentication. Please check your inbox.";
}
...
if ($result->num_rows === 1) {
    ...
    $twofa_enabled = $user['user_verified'];
}
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <p class="text-secondary-50 small mb-0">
                                    ...
                                    <div class="d-grid gap-2 mt-2">
                                        <a href="profile.php" class="btn btn-light py-2 shadow-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-person-gear me-2" viewBox="0 0 16 16">
                                                <path
                                ...
                                <div class="card-header bg-white p-4 border-0">
                                    <div class="d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            fill="currentColor" class="bi bi-pencil-square text-primary me-2"
                                            viewBox="0 0 16 16">
                                            <path
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 pe-lg-4 mb-4 mb-lg-0">
                                                ...
                                                <div class="mb-4 border-top pt-4">
                                                    ...
                                                    <div class="mt-2">
                                                        <?php if ($twofa_enabled == 1): ?>
                                                            <div class="alert alert-success d-flex align-items-center" role="alert">
                                                                2FA is Enabled
                                                            </div>
                                                            <!-- Use a link with JavaScript instead of a nested form -->
                                                            <a href="profile.php?action=disable2fa" class="btn btn-outline-danger">Disable 2FA</a>
                                                        <?php else: ?>
                                                            <p class="text-muted mb-2">
                                                                Enable two-factor authentication to add an extra layer of security to your account.
                                                            </p>
                                                            <!-- Use a link with JavaScript instead of a nested form -->
                                                            <a href="profile.php?action=enable2fa" class="btn btn-primary">Enable Email 2FA</a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-5 ps-lg-4">
                                                <h5 class="d-flex align-items-center mb-3 pb-2 border-bottom">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        fill="currentColor" class="bi bi-shield-lock me-2"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                ...
                                                <p class="text-muted small mb-3">Leave these fields empty if you don't
                                                    ...
                                                    <div class="mt-2">
                                                        <div class="d-flex flex-wrap gap-2 password-requirements">
                                                            <span class="badge bg-light text-dark p-2"
                                                                id="req-length">8+ characters</span>
                                                            <span class="badge bg-light text-dark p-2"
                                                                id="req-uppercase">Uppercase</span>
                                                            <span class="badge bg-light text-dark p-2"
                                                                id="req-lowercase">Lowercase</span>
                                                            <span class="badge bg-light text-dark p-2"
                                                                id="req-number">Number</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-12">
                                                    <div class="d-grid">
                                                        <button type="submit"
                                                            class="btn btn-primary btn-lg py-3 shadow">Update Profile</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
