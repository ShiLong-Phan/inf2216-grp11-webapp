...
<div class="footer-divider">
  <div class="container-fluid">
    <hr class="footer-separator"
        style="height: 3px; background-color: #dee2e6; border: none; margin-bottom: 0;">
  </div>
</div>
...
<footer id="footer-bottom" class="py-3">
  <div class="container-fluid">
    <div class="row justify-content-center align-items-center">
      ...
      <!-- Logo -->
      <div class="col-auto">
        <img src="images/logo.png" alt="Crumbly Logo" class="footer-logo" style="height: 80px; width: auto; margin-right: 0.5rem;">
      </div>

      <!-- Copyright text -->
      <div class="col-auto">
        <p class="mb-0">&copy; 2025 Crumbly. All rights reserved.</p>
      </div>
