...
if (isset($_SESSION['user_id'])) {
    ...
    if ($conn) {
        ...
        $stmt = $conn->prepare("SELECT c.cart_prod_id, c.cart_quantity, c.cart_prod_price, p.prod_name, p.prod_image, p.prod_description 
        ...
        <div class="order-md-last">
            ...
            <?php else: ?>
                ...
                <?php else: ?>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div class="d-flex align-items-center">
                                        <?php if (!empty($item['prod_image'])): ?>
                                            <img src="images/products/<?php echo $item['prod_image']; ?>" alt="<?php echo htmlspecialchars($item['prod_name']); ?>" class="me-2" style="width: 50px; height: 50px; object-fit: cover;">
                                        <?php else: ?>
                                            <div class="me-2 bg-light" style="width: 50px; height: 50px; display: flex; align-items: center; justify-content: center;">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-body-secondary">$<?php echo number_format($item['cart_prod_price'], 2); ?> each</small>
                                        </div>
                                    </div>
                                    <span class="text-body-secondary">$<?php echo number_format($item['cart_quantity'] * $item['cart_prod_price'], 2); ?></span>
                                </div>
                    ...
                    <button class="w-100 btn btn-primary btn-lg" onclick="window.location.href='checkout.php'">Continue to checkout</button>
                <?php endif; ?>
            <?php endif; ?>
        </div>
    </div>
